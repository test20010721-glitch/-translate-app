...
const STYLE_PROMPTS = {
  casual: (text, lang) => `以下の文章を${LANG_NAMES[lang]||lang}のカジュアルな口語表現に書き換えてください。友達同士で話すような自然な言葉遣いにしてください。結果のみを返してください。\n\n元の文章:\n${text}`,
  business: (text, lang) => `以下の文章を${LANG_NAMES[lang]||lang}のビジネス向け表現に書き換えてください。プロフェッショナルで自然なビジネス文体にしてください。結果のみを返してください。\n\n元の文章:\n${text}`,
  polite: (text, lang) => `以下の文章を${LANG_NAMES[lang]||lang}の丁寧な表現に書き換えてください。礼儀正しく温かみのある敬語にしてください。結果のみを返してください。\n\n元の文章:\n${text}`,
  email: (text, lang) => `以下の内容をもとに、${LANG_NAMES[lang]||lang}のビジネスメールを作成してください。挨拶文・本文・締めの言葉を含めた完全なメール文を書いてください。結果のみを返してください。\n\nメールの内容:\n${text}`,
  menu: (text, lang) => {
